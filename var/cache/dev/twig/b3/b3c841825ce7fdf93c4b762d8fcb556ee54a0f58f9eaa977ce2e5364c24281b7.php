...
class __TwigTemplate_e74edec816aa756cff74ddbee85d2e3e16d3928f0c5c24728b99951a22220f75 extends Template
{
    ...
    ";
        ...
        if (($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN") && $this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("IS_AUTHENTICATED_FULLY"))) {
            // line 9
            echo "    <a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add_editor");
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["editor"]) {
            ...
            ";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["editor"], "societyName", [], "any", false, false, false, 20), "html", null, true);
            echo " - ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["editor"], "nationality", [], "any", false, false, false, 20), "html", null, true);
            echo "
        <a href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("editor_infos", ["idEditor" => twig_get_attribute($this->env, $this->source, $context["editor"], "id", [], "any", false, false, false, 21)]), "html", null, true);
            echo "\">Plus d'infos</a>
            ";
            // line 22
            if (($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN") && $this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("IS_AUTHENTICATED_FULLY"))) {
                // line 23
                echo "        <a href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("update_editor", ["idEditor" => twig_get_attribute($this->env, $this->source, $context["editor"], "id", [], "any", false, false, false, 23)]), "html", null, true);
                echo "\">Modifier</a>
        <a href=\"";
                // line 24
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("delete_editor", ["idEditor" => twig_get_attribute($this->env, $this->source, $context["editor"], "id", [], "any", false, false, false, 24)]), "html", null, true);
                echo "\">Supprimer</a>
            ";
            }
            // line 26
...
";
    ...
    {
        return array (  158 => 28,  151 => 26,  146 => 24,  141 => 23,  139 => 22,  135 => 21,  129 => 20,  126 => 19,  122 => 18,  119 => 17,  110 => 14,  107 => 13,  103 => 12,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
", "editor/index.html.twig", "/Applications/MAMP/htdocs/SYMFONYPROJECT/templates/editor/index.html.twig");
    }
}
